...
public class ReportDoctorLocal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        documentfoundnum.setBounds(80, 480, 70, 30);
        ...
        btnPrint.setBounds(610, 480, 90, 30);
        ...
        jLabel3.setBounds(20, 480, 60, 25);
        ...
        btnPrint1.setActionCommand("Print V.2");
        btnPrint1.setBackground(new java.awt.Color(255, 255, 204));
        btnPrint1.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        btnPrint1.setLabel("New Print");
        btnPrint1.setName(""); // NOI18N
...
//            use to check which row is checked
            for (int i = 0; i <= model1.getRowCount() - 1; i++) {
                ...
                if (print) {
                    ...
                    cgr.GetReportDoctorLocalLocation(conumber, year, lastrow);
                    //selectedyear คือปีที่ จำ กับ selectednum คือเลข invoice ที่เลือก
                    //System.out.print("allyear is " + selectedyear);
                    //System.out.print("allnum is " + selectednum);
    ...
    private java.awt.Button btnPrint1;
