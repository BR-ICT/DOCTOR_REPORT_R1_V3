...
public class LoginMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbm_group = new javax.swing.JComboBox<>();
        ...
        btncancel.setBounds(250, 290, 90, 30);
        ...
        btnlogin.setBounds(140, 290, 90, 30);
        ...
        cbm_group.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Normal/Local Sale", "Fish Farm", "THAIMAX" }));
        ...
        cbm_group.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                cbm_groupPropertyChange(evt);
            }
        });
        getContentPane().add(cbm_group);
        cbm_group.setBounds(140, 200, 200, 29);

        jLabel5.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(51, 51, 51));
        jLabel5.setText("Program");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(70, 240, 60, 30);

        setSize(new java.awt.Dimension(504, 390));
...
//                String ReportN = "FarmFish";
                ...
                if (ReportN.equals("Normal")) {
                    ...
                    ProgramName = "Farm";
                    rpf.setVisible(true);
                } else if (ReportN.equalsIgnoreCase("Local Sale")) {
                    ReportDoctorLocal rpf = new ReportDoctorLocal();
                    ProgramName = "Local";
                    rpf.setVisible(true);
                } else if (ReportN.equalsIgnoreCase("Doctor Rpt Summary - Normal")) {
                    ReportDoctorSummary rps = new ReportDoctorSummary();
                    rps.setVisible(true);
                } else if (ReportN.equalsIgnoreCase("Doctor Rpt Summary - FISHFARM")) {
                    ReportDoctorSummaryFishFarm rps = new ReportDoctorSummaryFishFarm();
                    rps.setVisible(true);
                } else if (ReportN.equalsIgnoreCase("Doctor Rpt Summary - THAIMAX")) {
                    ReportDoctorSummaryThaiMax rps = new ReportDoctorSummaryThaiMax();
                    rps.setVisible(true);
                } else if (ReportN.equalsIgnoreCase("Doctor Rpt Summary - Transfer")) {
    ...
    private void cbm_groupItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbm_groupItemStateChanged
        // TODO add your handling code here:
        ...
        if (selecteditem.equals("Normal/Local Sale")) {
            ...
            cbm_programe.addItem("Fish Farm");
            cbm_programe.addItem("Doctor Rpt Summary - FISHFARM");
            cbm_programe.addItem("Summary Report - Month Generation");
        } else if (selecteditem.equals("THAIMAX")) {
            cbm_programe.addItem("THAIMAX");
            cbm_programe.addItem("THAIMAXnew");
            cbm_programe.addItem("Doctor Rpt Summary - THAIMAX");
        }
    }//GEN-LAST:event_cbm_groupItemStateChanged

    private void cbm_groupPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_cbm_groupPropertyChange
        // TODO add your handling code here:
    }//GEN-LAST:event_cbm_groupPropertyChange
    ...
    private javax.swing.JComboBox<String> cbm_group;
