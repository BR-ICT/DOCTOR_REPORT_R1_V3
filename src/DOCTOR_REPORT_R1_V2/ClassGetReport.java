...
//                Sql += "  GROUP BY  h.UAORNO,d.ESTCOMPANY , d.YEARDOCTOR ,dd.RUNNINGNO";
                ...
                Sql = " INSERT INTO BRLDTA0100.PRODOCTORAUTO (UBORNO,NODOCUMENT,YEARDOCTOR,ESTCOMPANY,RUNNINGNO,DATERUNREPORT ) ";
                Sql += "      SELECT h.UAORNO,d.ESTCOMPANY ||'/'|| d.YEARDOCTOR ||'/'|| RIGHT(dd.RUNNINGNO,6) AS   NODOCUMENT ";
                Sql += "        ,d.YEARDOCTOR,d.ESTCOMPANY ,RIGHT(dd.RUNNINGNO,6),h.UAIVDT";
                Sql += "       FROM M3FDBPRD.ODHEAD AS h ";
                Sql += "       LEFT JOIN BRLDTA0100.PRODOCTOREST14 AS d ON h.UAIVDT BETWEEN d.STARTDATE AND d.ENDDATE ";
                Sql += "       LEFT JOIN (SELECT CASE WHEN  MAX(runningno+1)<100000 THEN '00000'|| MAX(runningno+1) ";
                Sql += "         ELSE CAST(MAX(runningno+1)AS CHAR(100) )  END AS RUNNINGNO ,YEARDOCTOR       FROM BRLDTA0100.PRODOCTORAUTO  ";
                Sql += "        WHERE   ESTCOMPANY=14 GROUP BY YEARDOCTOR ) AS dd  ON dd.yeardoctor=d.YEARDOCTOR     ";
                Sql += "       WHERE h.UAORNO='" + OAORNO + "' AND h.UACONO=10 ";
                Sql += "  GROUP BY  h.UAORNO,UAIVDT,d.ESTCOMPANY , d.YEARDOCTOR ,dd.RUNNINGNO";
                try {
...
//            view4.setVisible(true);
    ...
    public void GetReportDoctorSummaryExcelFromData(String Years, String Month) {
        // TODO add your handling code here:
        String PathFile = System.getProperty("user.dir").toString() + "\\Report\\";
//        String name = PathFile + "SummaryDoctorMonthExcell.jasper";
//        String name = PathFile + "rptSummaryDoctorMonthXLSX.jasper";
...
//            view4.setVisible(true);
    ...
    public void GetReportDoctorSummaryPackaging(String Years, String Month) {
        // TODO add your handling code here:
        String PathFile = System.getProperty("user.dir").toString() + "\\Report\\";
//        String name = PathFile + "SummaryDoctorMonthExcell.jasper";
//        String name = PathFile + "rptSummaryDoctorMonthXLSX.jasper";
        String name2 = PathFile + "rptSummaryDoctorMonthXLSXwithPackage.jasper";
//        String name3 = PathFile + "rptSummaryDoctorMonthXLSX_farmpra.jasper";
...
//            view4.setVisible(true);
    ...
    public void GetReportDoctorSummaryPackagingTransfer(String Years, String Month) {
        // TODO add your handling code here:
        String PathFile = System.getProperty("user.dir").toString() + "\\Report\\";
//        String name = PathFile + "SummaryDoctorMonthExcell.jasper";
//        String name = PathFile + "rptSummaryDoctorMonthXLSX.jasper";
        String name2 = PathFile + "rptSummaryDoctorMonthXLSXwithPackageTransfer.jasper";
//        String name3 = PathFile + "rptSummaryDoctorMonthXLSX_farmpra.jasper";
...
//            view4.setVisible(true);
    ...
    public void GetReportDoctorSummaryExcelThaimax(String Years, String Month) {
        // TODO add your handling code here:
        String PathFile = System.getProperty("user.dir").toString() + "\\Report\\";
//        String name = PathFile + "SummaryDoctorMonthExcell.jasper";
//        String name = PathFile + "rptSummaryDoctorMonthXLSX.jasper";
        String name2 = PathFile + "rptSummaryDoctorMonthXLSXLocalTHAIMAX.jasper";
//        String name3 = PathFile + "rptSummaryDoctorMonthXLSX_farmpra.jasper";
        ...
        try {
            ...
            Map parameterss3 = new HashMap();
            parameterss3.put("PMonthNumber", Month);
...
//                return getErrorJRPrint(ex);
    ...
    public void GetReportDoctorSummaryExcelFishFarm(String Years, String Month) {
        // TODO add your handling code here:
        String PathFile = System.getProperty("user.dir").toString() + "\\Report\\";
//        String name = PathFile + "SummaryDoctorMonthExcell.jasper";
//        String name = PathFile + "rptSummaryDoctorMonthXLSX.jasper";
        String name2 = PathFile + "rptSummaryDoctorMonthXLSXLocalFishFarm.jasper";
//        String name3 = PathFile + "rptSummaryDoctorMonthXLSX_farmpra.jasper";
...
//        String name = PathFile + "SummaryDoctorMonthExcell.jasper";
//        String name = PathFile + "rptSummaryDoctorMonthXLSX.jasper";
        String name2 = PathFile + "rptSummaryDoctorMonthXLSXLocalFishFarmAddressloc.jasper";
//        String name3 = PathFile + "rptSummaryDoctorMonthXLSX_farmpra.jasper";
...
//            }
    ...
    public void GetReportDoctorLocation(String GRNNUMBER) {
        // TODO add your handling code here:
        File myFile = new File(new JFileChooser().getFileSystemView().getDefaultDirectory().toString() + "\\doctorreport.pdf");
        String PathFile = System.getProperty("user.dir").toString() + "\\Report\\";
        String name = PathFile + "rptCerDoctorHeadlocation.jasper";
...
//            System.out.println(System.getProperty("user.dir").toString() + "\\Report.pdf");
    ...
    public void GetReportDoctorLocalLocation(String GRNNUMBER, String subYear, boolean lastrow) {
        // TODO add your handling code here:
        File myFile = new File(new JFileChooser().getFileSystemView().getDefaultDirectory().toString() + "\\duckhealthcheckup.pdf");

        String PathFile = System.getProperty("user.dir").toString() + "\\Report\\";
        String name = PathFile + "rptCerDoctorHeadLocalLocation.jasper";
...
//          parameterss.put("POAORNO", GRNNUMBER);
    ...
    public void getReportSetSeriesLocation(String Program, String customercode, String Weight,
            String doctorcode, String doctorname, boolean select1, boolean select2) {
        // TODO add your handling code here:
        String PathFile = System.getProperty("user.dir").toString() + "\\Report\\";
        ...
        String name = PathFile + "SetSeriesLocation.jasper";
...
//          Connection connect = ConnectDB2.ConnectionDB();
            ...
            parameterss.put("Program", Program);
            parameterss.put("User", LoginMain.LoginUsername);
//            parameterss.put("Lotnum", lotnum);
            parameterss.put("Customer", customercode);
//            parameterss.put("Customername", custoemrname);
//            parameterss.put("Lotdate", Lotdateformatted);
            parameterss.put("Weight", Weight);
            parameterss.put("Docname", doctorname);
            parameterss.put("Doccode", doctorcode);
            parameterss.put("typecheck", typeselection);
...
//            }
    ...
    public void getReportFarmPraLocation(String CONumber, Integer subyear, String doctorname, String doctornum) {
        ...
        File myFile = new File(new JFileChooser().getFileSystemView().getDefaultDirectory().toString() + "\\farmprareport.pdf");
        String PathFile = System.getProperty("user.dir").toString() + "\\Report\\";
        String name = PathFile + "rptCerDoctorHeadFarmPraLocation.jasper";
        try {
//          Connection conn = ConnectMsSql.ConnectionDB();
            Connection conn = ConnectDB2.ConnectionDB();
            //JRResultSetDataSource resultSetDataSource = new   JRResultSetDataSource(Rs1);
            ...
            parameterss.put("POAORNO", CONumber);
            parameterss.put("Docname", doctorname);
            parameterss.put("Doccode", doctornum);
            JasperPrint print = JasperFillManager.fillReport(name, parameterss, conn);
            JasperViewer view = new JasperViewer(print, false);
            view.setVisible(true);
...
//            }
    ...
    public void getReportFarmPraLocationwithnodoctor(String CONumber, Integer subyear) {
        // TODO add your handling code here:
        File myFile = new File(new JFileChooser().getFileSystemView().getDefaultDirectory().toString() + "\\farmprareport.pdf");
        String PathFile = System.getProperty("user.dir").toString() + "\\Report\\";
        String name = PathFile + "rptCerDoctorHeadFarmPraLocationWithoutDoc.jasper";
        try {
//          Connection conn = ConnectMsSql.ConnectionDB();
            Connection conn = ConnectDB2.ConnectionDB();
            //JRResultSetDataSource resultSetDataSource = new   JRResultSetDataSource(Rs1);
